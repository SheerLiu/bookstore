...
<body>
	...
	<div id="content-wrapper" class="container">
		...
		<section class="piclist">
			...
			<ul>
				<li><a href="details?name=《HTML与CSS实例教程》"><img src="../images/prod1.jpg" id="img01" name="piclist" draggable="true" alt="58" title="《HTML和CSS3实例教程》"></a></li>
				<li><a href="details?name=《HTML5权威指南(图灵出品)》"><img src="../images/prod2.jpg" id="img02" name="piclist" draggable="true" alt="98" title="《HTML和CSS3实例教程》"></a></li>
				<li><a href="details?name=《JavaScript权威指南》"><img src="../images/prod3.jpg" id="img03" name="piclist" draggable="true" alt="48" title="《HTML和CSS3实例教程》"></a></li>
			</ul>
			<ul>
				<li><a href="details?name=《响应式Web设计》"><img src="../images/prod5.jpg" id="img05" name="piclist" draggable="true" alt="28" title="《HTML和CSS3实例教程》"></a></li>
